...
| WhatsApp | Sem DataView nativa (Rastreamento via ChatMessagingDetailExtract ou Intelligence Reports) |
...
- `dataviews/whatsapp` - DataViews de WhatsApp (tempo real/automático)
